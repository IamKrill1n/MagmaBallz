# TRẠNG THÁI — tự sinh lúc 2026-08-21 00:39
...
|---|---|---|
| ❌ verify | HỎNG | giữ 1/3, đòi lại 3/3 — CÓ HỒI QUY, không được nộp build này, xem lại thiết kế cộng-thêm |
| ✅ marathon | ĐẠT | 99/99 = 100.0% (kỳ vọng ≥95% — Solo cùng đề đạt ~99%) |
| ◐ sweep | DỞ DANG | 4/2469, đang giải 4 |
...
- verify: giữ 1/3, đòi lại 3/3 — CÓ HỒI QUY, không được nộp build này, xem lại thiết kế cộng-thêm
